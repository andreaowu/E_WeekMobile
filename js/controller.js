...
eweekApp.controller('EventListCtrl', function($scope, $routeParams) {
	$scope.events = [
		...
		{"name": "Design & Build",
			...
			"description": "Put your engineering skills to the test! Engineering students will form teams and face off to overcome a unique design challenge to do some hands-on building! The competition will be a spin-off the Competition details will be released at the beginning of the event. Dinner will be served!",
			"tag": "Compete",
