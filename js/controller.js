...
eweekApp.controller('EventListCtrl', function($scope, $routeParams) {
	$scope.events = [
		{"name": "Networking",
			...
			"description": "Come meet industry professionals and talk to them about their professional experiences. Hor d'oeuvres will be served!",
		...
		{"name": "Casino Night",
			...
			"description": "Never been to a casino? This is your chance! There will be multiple tables set up for poker, roulette, pai gao, and more, with professional card dealers. There will also be entertainment, including a magic act, and refreshments will be provided.",
			"tag": "Meet & Eat",
		...
		{"name": "Innovations in Engineering I",
			"day": "Tuesday",
			...
			"tag": "Speakers",
			"imgUrl": "img/keynote.png"},
		{"name": "Innovations in Engineering II",
			"day": "Thursday",
		...
		{"name": "Puzzle Hunt",
			...
			"description": "Enjoy solving puzzles? Come join the puzzle hunt! Form teams and walk (or run) around campus using our bright engineering minds to solve puzzles. Make sure you wear comfortable clothes and shoes. Awards ceremony and dinner served afterward. (If you can't stay the entire time or have to come late, don't worry! You can come join whenever you're free.)",
			"tag": "Compete",
		...
		{"name": "Design & Build",
			...
			"description": "Put your engineering skills to the test! Engineering departments will form teams and face off to overcome a unique design challenge and make some cool stuff! Competition details will be released at the beginning of the event. Dinner will be served!",
			"tag": "Compete",
