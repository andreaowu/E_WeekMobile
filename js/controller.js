...
eweekApp.controller('EventListCtrl', function($scope, $routeParams) {
	$scope.events = [
		...
		{"name": "Innovations in Engineering II",
			...
			"description": "We are still in the process of figuring this out, but there will be a speaker from Boeing! Stay tuned for details!",
			"tag": "Speakers",
			"imgUrl": "img/keynote.png"},
		{"name": "Puzzle Hunt",
			"day": "Tuesday",
